  ...
  return (
    <>
      <div className="flex justify-between items-center mb-4 rounded-xl">
        <h3 className="xl:text-2xl md:text-xl text-md font-semibold text-black dark:text-white"> Articles </h3>
        <a href="/articles" className="xl:text-sm text-xs transition w-fit text-blue-600 hover:text-black font-semibold w-full flex justify-end"> Mange benefits </a>
      </div>
      <div className="">
